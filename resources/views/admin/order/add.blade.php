        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="{{ route('order.index') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="paymentstatus" class="form-control" placeholder="paymentstatus">
                  </div>
                </div>
                <!-- /.card-body -->
